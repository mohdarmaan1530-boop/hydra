...
- [Instantiate resolution and call-site overrides](https://hydra.cc/docs/upgrades/1.3_to_1.4/instantiate_resolution)
- [Instantiate target whitelist](https://hydra.cc/docs/upgrades/1.3_to_1.4/instantiate_target_whitelist)
...
- Replace `hydra.job.override_dirname` with the
  [`hydra_override_dirname` resolver](https://hydra.cc/docs/upgrades/1.3_to_1.4/hydra_job_override_dirname).
- Nevergrad Sweeper users should move `hydra.sweeper.parametrization` to
  [`hydra.sweeper.params`](https://hydra.cc/docs/upgrades/1.3_to_1.4/nevergrad_sweeper).
